...
ถ้าเรากำหนดให้$$f$$นั้นต่อเนื่องบน$$[a, b]$$และ$$f(b)f(a)<0$$ 

เมื่อเราใช้วิธีการแบ่งครึ่งช่วงจะได้ว่า $${x_n}$$ นั้นลู่เข้าสู่ $$r$$ ที่เป็นรากของสมการ $$f(x)= 0$$ และ \$$|e_n| = |r-x_n| \leq | \frac{b-a}{2^{n+1}} | \leq \epsilon$$ 

เมื่อ $$|e_n$$คือค่าความคลาดเคลื่อนในการทำซ้ำรอบที่ n และ $$\epsilon$$ คือขอบเขตความคาดเคลื่อน
